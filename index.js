...
function loadConfig() {
    ...
    if (process.env.MONGODB_URI) config.mongodb.database = process.env.MONGODB_URI;
    if (process.env.MATCHMAKER_IP) config.matchmakerIP = process.env.MATCHMAKER_IP;
    if (process.env.GAME_SERVER_IP) config.gameServerIP = process.env.GAME_SERVER_IP;
    if (process.env.RAILWAY_PUBLIC_DOMAIN) {
        config.matchmakerIP = process.env.RAILWAY_PUBLIC_DOMAIN;
        config.useWss = true;
    }
    return config;
}
